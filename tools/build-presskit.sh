...
NAME="Hoerspieler"                                  # ASCII on purpose: this becomes a filename that
                                                    # has to survive Windows, email and unzip tools.
...
cp "$ROOT/tools/presskit-readme.txt" "$STAGE/LIESMICH.txt"
